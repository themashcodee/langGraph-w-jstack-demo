	...
	return (
		<main className="flex min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 flex-col items-center justify-center relative isolate">
			...
			<div className="container flex flex-col items-center justify-center gap-6 px-4 py-16">
				...
				>
					<span>Employee Data Assistant</span>
				</h1>

				<p className="text-[#ececf399] text-lg/7 md:text-xl/8 text-pretty sm:text-wrap sm:text-center text-center mb-8">
					A learning project to explore building AI agents with{" "}
					<span className="text-emerald-400">LangGraph</span>,{" "}
					<span className="text-blue-400">LangChain</span>, and{" "}
					<span className="text-emerald-400">LangSmith</span>.{" "}
					<span className="inline sm:block mt-2">
						Built as an HR assistant that can manage employee data using natural
						language.
					</span>
				</p>
